...
class EnvConfig(private val environment: Environment = Environment.DEVELOPMENT) {
    ...
    val predictionUri : String
        get() = if (environment == Environment.DEVELOPMENT) "iccdev://react-fe-en.icc-dev.deltatre.digital/tournaments/t20cricketworldcup/matches" else "icc://www.icc-cricket.com/tournaments/t20cricketworldcup/fans/predictor"
